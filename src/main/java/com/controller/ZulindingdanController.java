...
public class ZulindingdanController {
     ...
     * 删除
     */
    @PostMapping("/deleteByZulinbianhao")
    public R deleteByZulinbianhao(@RequestBody Map<String, Object> zulinbianhao){
        Map<String, Object> m = new HashMap<>();
        m.put("zulinbianhao", zulinbianhao.get("zulinbianhao"));
        zulindingdanService.deleteByZulinbianhao(m);
        return R.ok();
    }

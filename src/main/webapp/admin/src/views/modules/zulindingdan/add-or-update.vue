    ...
    >
      <el-row>
        <el-col :span="12">
          ...
          <div v-else>
            <el-form-item v-if="ruleForm.zulinbianhao" class="input" label="租赁编号" prop="zulinbianhao">
              <el-input v-model="ruleForm.zulinbianhao"
                        placeholder="租赁编号" readonly></el-input>
            </el-form-item>
          </div>
          ...
          <el-col :span="12">
            <el-form-item v-if="type!='info'" class="input" label="押金" prop="yajin">
              <el-input v-model="ruleForm.yajin"
                        :readonly="ro.yajin" clearable placeholder="每小时费用"></el-input>
            </el-form-item>
            <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="date" label="开始时间" prop="kaishishijian">
            <el-date-picker
          ...
          <div v-else>
            <el-form-item v-if="ruleForm.kaishishijian" class="input" label="开始时间" prop="kaishishijian">

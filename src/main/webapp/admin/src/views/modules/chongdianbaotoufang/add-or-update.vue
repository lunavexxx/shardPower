<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
        <el-col v-if="ruleForm.chongdianbaobianhao != ''" :span="12">
          ...
          <div v-else>
            <el-form-item v-if="ruleForm.chongdianbaobianhao" class="input" label="充电宝编号"
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="详细地址" prop="xiangxidizhi">
            <el-input v-model="ruleForm.xiangxidizhi"
                      :readonly="ro.xiangxidizhi" clearable placeholder="详细地址"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="品牌" prop="pinpai">
            <el-input v-model="ruleForm.pinpai"
                      :readonly="ro.pinpai" clearable placeholder="品牌"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col v-if="ruleForm.chongdianbaobianhao != ''" :span="12">
          <el-form-item v-if="type!='info'" class="input" label="剩余电量" prop="shengyudianliang">
            <el-input v-model="ruleForm.shengyudianliang"
                      :readonly="ro.shengyudianliang" clearable placeholder="剩余电量"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="押金" prop="shengyudianliang">
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="date" label="投放时间" prop="toufangshijian">
            <el-date-picker
          ...
          <div v-else>
            <el-form-item v-if="ruleForm.toufangshijian" class="input" label="投放时间" prop="toufangshijian">
        ...
        <el-col v-if="ruleForm.chongdianbaobianhao == ''" :span="12">
          <el-form-item class="input" label="投放数量" prop="shuliang">
            <el-input-number v-model="shuliang"
                             :max="100" :min="1"
                             placeholder="投放数量"></el-input-number>
          </el-form-item>
        </el-col>
        <el-col :span="24">
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          if (this.ruleForm.id) {
            this.$http({
              url: `chongdianbaotoufang/update`,
              method: "post",
              data: this.ruleForm
            }).then(({data}) => {
              if (data && data.code === 0) {
            ...
            this.$http({
              url: `chongdianbaotoufang/saveMany`,
              method: "post",
              data: data
            }).then(({data}) => {
              if (data && data.code === 0) {

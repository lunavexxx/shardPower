  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row :gutter="20" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}"
          ...
          <el-form-item :label="contents.inputTitle == 1 ? '商户编号' : ''">
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" v-model="searchForm.shanghubianhao"
                      clearable placeholder="商户编号" prefix-icon="el-icon-search"></el-input>
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" v-model="searchForm.shanghubianhao"
                      clearable placeholder="商户编号" suffix-icon="el-icon-search"></el-input>
            <el-input v-if="contents.inputIcon == 0" v-model="searchForm.shanghubianhao" clearable
      ...
      <div class="table-content">
        <el-table v-if="isAuth('chongdianbaotoufang','查看')" v-loading="dataListLoading" :border="contents.tableBorder"
          ...
          <el-table-column :align="contents.tableAlign" header-align="center"
            ...
            <template slot-scope="scope">
              <el-button
                  v-if="isAuth('chongdianbaotoufang','查看') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                  icon="el-icon-tickets" size="mini" type="success" @click="addOrUpdateHandler(scope.row.id,'info')">
                {{ contents.tableBtnFont == 1 ? '详情' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('chongdianbaotoufang','查看') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
              ...
              <el-button v-if="isAuth('chongdianbaotoufang','查看') && contents.tableBtnIcon == 0" size="mini"
                         type="success" @click="addOrUpdateHandler(scope.row.id,'info')">
                {{ contents.tableBtnFont == 1 ? '详情' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('chongdianbaotoufang','租赁') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                  icon="el-icon-tickets" size="mini" type="success"
                  @click="zulindingdanCrossAddOrUpdateHandler(scope.row,'cross')">
                {{ contents.tableBtnFont == 1 ? '租赁' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('chongdianbaotoufang','租赁') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
                  size="mini" type="success" @click="zulindingdanCrossAddOrUpdateHandler(scope.row,'cross')">
                {{ contents.tableBtnFont == 1 ? '租赁' : '' }}<i class="el-icon-tickets el-icon--right"/></el-button>
              <el-button v-if="isAuth('chongdianbaotoufang','租赁') && contents.tableBtnIcon == 0" size="mini"
                         type="success" @click="zulindingdanCrossAddOrUpdateHandler(scope.row,'cross')">
                {{ contents.tableBtnFont == 1 ? '租赁' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('chongdianbaotoufang','维护登记') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                  icon="el-icon-tickets" size="mini" type="success"
                  @click="chongdianbaoweihuCrossAddOrUpdateHandler(scope.row,'cross')">
                {{ contents.tableBtnFont == 1 ? '维护登记' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('chongdianbaotoufang','维护登记') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
                  size="mini" type="success" @click="chongdianbaoweihuCrossAddOrUpdateHandler(scope.row,'cross')">
                {{ contents.tableBtnFont == 1 ? '维护登记' : '' }}<i class="el-icon-tickets el-icon--right"/>
              </el-button>
              <el-button v-if="isAuth('chongdianbaotoufang','维护登记') && contents.tableBtnIcon == 0" size="mini"
                         type="success" @click="chongdianbaoweihuCrossAddOrUpdateHandler(scope.row,'cross')">
                {{ contents.tableBtnFont == 1 ? '维护登记' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('chongdianbaotoufang','修改') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                  icon="el-icon-edit" size="mini" type="primary" @click="addOrUpdateHandler(scope.row.id)">
                {{ contents.tableBtnFont == 1 ? '修改' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('chongdianbaotoufang','修改') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
              ...
              <el-button v-if="isAuth('chongdianbaotoufang','修改') && contents.tableBtnIcon == 0" size="mini"
              ...
              <el-button
                  v-if="isAuth('chongdianbaotoufang','删除') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                  icon="el-icon-delete" size="mini" type="danger" @click="deleteHandler(scope.row.id)">
                {{ contents.tableBtnFont == 1 ? '删除' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('chongdianbaotoufang','删除') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
              ...
              <el-button v-if="isAuth('chongdianbaotoufang','删除') && contents.tableBtnIcon == 0" size="mini"
    ...
    <zulindingdan-cross-add-or-update v-if="zulindingdanCrossAddOrUpdateFlag" ref="zulindingdanCrossaddOrUpdate"
                                      :parent="this"></zulindingdan-cross-add-or-update>
    <chongdianbaoweihu-cross-add-or-update v-if="chongdianbaoweihuCrossAddOrUpdateFlag" ref="chongdianbaoweihuCrossaddOrUpdate"
                                           :parent="this"></chongdianbaoweihu-cross-add-or-update>

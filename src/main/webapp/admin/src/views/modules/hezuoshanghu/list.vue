  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      ...
      <div class="table-content">
        <el-table v-if="isAuth('hezuoshanghu','查看')" v-loading="dataListLoading" :border="contents.tableBorder"
          ...
          <el-table-column :align="contents.tableAlign" :sortable="contents.tableSortable" header-align="center"
            ...
            <template slot-scope="scope">
              <div v-if="scope.row.shanghutupian">
                <img :src="scope.row.shanghutupian.split(',')[0]" height="100" width="100">
              </div>
              <div v-else>无图片</div>
            </template>
          </el-table-column>
          ...
          <el-table-column :align="contents.tableAlign" header-align="center"
            ...
            <template slot-scope="scope">
              <el-button
                  v-if="isAuth('hezuoshanghu','查看') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                  icon="el-icon-tickets" size="mini" type="success" @click="addOrUpdateHandler(scope.row.id,'info')">
                {{ contents.tableBtnFont == 1 ? '详情' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('hezuoshanghu','查看') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
              ...
              <el-button v-if="isAuth('hezuoshanghu','查看') && contents.tableBtnIcon == 0" size="mini" type="success"
                         @click="addOrUpdateHandler(scope.row.id,'info')">{{ contents.tableBtnFont == 1 ? '详情' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('hezuoshanghu','投放') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                  icon="el-icon-tickets" size="mini" type="success"
                  @click="chongdianbaotoufangCrossAddOrUpdateHandler(scope.row,'cross')">
                {{ contents.tableBtnFont == 1 ? '投放' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('hezuoshanghu','投放') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
                  size="mini" type="success" @click="chongdianbaotoufangCrossAddOrUpdateHandler(scope.row,'cross')">
                {{ contents.tableBtnFont == 1 ? '投放' : '' }}<i class="el-icon-tickets el-icon--right"/></el-button>
              <el-button v-if="isAuth('hezuoshanghu','投放') && contents.tableBtnIcon == 0" size="mini" type="success"
                         @click="chongdianbaotoufangCrossAddOrUpdateHandler(scope.row,'cross')">
                {{ contents.tableBtnFont == 1 ? '投放' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('hezuoshanghu','修改') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                  icon="el-icon-edit" size="mini" type="primary" @click="addOrUpdateHandler(scope.row.id)">
                {{ contents.tableBtnFont == 1 ? '修改' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('hezuoshanghu','修改') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
              ...
              <el-button v-if="isAuth('hezuoshanghu','修改') && contents.tableBtnIcon == 0" size="mini" type="primary"
                         @click="addOrUpdateHandler(scope.row.id)">{{ contents.tableBtnFont == 1 ? '修改' : '' }}
              </el-button>


              <el-button
                  v-if="isAuth('hezuoshanghu','删除') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                  icon="el-icon-delete" size="mini" type="danger" @click="deleteHandler(scope.row.id)">
                {{ contents.tableBtnFont == 1 ? '删除' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('hezuoshanghu','删除') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
              ...
              <el-button v-if="isAuth('hezuoshanghu','删除') && contents.tableBtnIcon == 0" size="mini" type="danger"
    ...
    <chongdianbaotoufang-cross-add-or-update v-if="chongdianbaotoufangCrossAddOrUpdateFlag" ref="chongdianbaotoufangCrossaddOrUpdate"
                                             :parent="this"></chongdianbaotoufang-cross-add-or-update>

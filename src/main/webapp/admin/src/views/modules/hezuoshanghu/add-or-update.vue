    ...
    >
      <el-row>
        <el-col :span="12">
          ...
          <div v-else>
            <el-form-item v-if="ruleForm.shanghubianhao" class="input" label="商户编号" prop="shanghubianhao">
              <el-input v-model="ruleForm.shanghubianhao"
                        placeholder="商户编号" readonly></el-input>
            </el-form-item>
          </div>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="联系人" prop="lianxiren">
            <el-input v-model="ruleForm.lianxiren"
                      :readonly="ro.lianxiren" clearable placeholder="联系人"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="联系方式" prop="lianxifangshi">
            <el-input v-model="ruleForm.lianxifangshi"
                      :readonly="ro.lianxifangshi" clearable placeholder="联系方式"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="商户号" prop="shanghuhao">
            <el-input v-model="ruleForm.shanghuhao"
                      :readonly="ro.shanghuhao" clearable placeholder="商户号"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="营业执照注册号" prop="lianxifangshi">
              <el-input v-model="ruleForm.shanghuhao"
                        placeholder="营业执照注册号" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="24">
          <el-form-item v-if="type!='info' && !ro.shanghutupian" class="upload" label="商户图片" prop="shanghutupian">
            <file-upload
          ...
          <div v-else>
            <el-form-item v-if="ruleForm.shanghutupian" label="商户图片" prop="shanghutupian">
              <img v-for="(item,index) in ruleForm.shanghutupian.split(',')" v-bind:key="index"
                   :src="item" height="100" style="margin-right:20px;" width="100">
            </el-form-item>
          </div>
        </el-col>
      </el-row>

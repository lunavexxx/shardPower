  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row :gutter="20" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}"
          ...
          <el-form-item :label="contents.inputTitle == 1 ? '租赁编号' : ''">
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" v-model="searchForm.zulinbianhao"
                      clearable placeholder="租赁编号" prefix-icon="el-icon-search"></el-input>
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" v-model="searchForm.zulinbianhao"
                      clearable placeholder="租赁编号" suffix-icon="el-icon-search"></el-input>
            <el-input v-if="contents.inputIcon == 0" v-model="searchForm.zulinbianhao" clearable
                      placeholder="租赁编号"></el-input>
          </el-form-item>
          <el-form-item :label="contents.inputTitle == 1 ? '充电宝编号' : ''">
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" v-model="searchForm.chongdianbaobianhao"
                      clearable placeholder="充电宝编号" prefix-icon="el-icon-search"></el-input>
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" v-model="searchForm.chongdianbaobianhao"
                      clearable placeholder="充电宝编号" suffix-icon="el-icon-search"></el-input>
            <el-input v-if="contents.inputIcon == 0" v-model="searchForm.chongdianbaobianhao" clearable
                      placeholder="充电宝编号"></el-input>
          </el-form-item>
      ...
      <div class="table-content">
        <el-table v-if="isAuth('feiyongdingdan','查看')" v-loading="dataListLoading" :border="contents.tableBorder"
          ...
          <el-table-column
              :align="contents.tableAlign" :sortable="contents.tableSortable"
              header-align="center"
              label="是否支付"
              prop="ispay">
            <template slot-scope="scope">
              <span style="margin-right:10px">{{ scope.row.ispay == '已支付' ? '已支付' : '未支付' }}</span>
              <el-button v-if="scope.row.ispay!='已支付' && isAuth('feiyongdingdan','支付') " icon="el-icon-edit"
                         size="small" type="text" @click="payHandler(scope.row)">支付
              </el-button>
            </template>
          </el-table-column>
          <el-table-column :align="contents.tableAlign" header-align="center"
            ...
            <template slot-scope="scope">
              <el-button
                  v-if="isAuth('feiyongdingdan','查看') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                  icon="el-icon-tickets" size="mini" type="success" @click="addOrUpdateHandler(scope.row.id,'info')">
                {{ contents.tableBtnFont == 1 ? '详情' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('feiyongdingdan','查看') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
              ...
              <el-button v-if="isAuth('feiyongdingdan','查看') && contents.tableBtnIcon == 0" size="mini" type="success"
                         @click="addOrUpdateHandler(scope.row.id,'info')">{{ contents.tableBtnFont == 1 ? '详情' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('feiyongdingdan','修改') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                  icon="el-icon-edit" size="mini" type="primary" @click="addOrUpdateHandler(scope.row.id)">
                {{ contents.tableBtnFont == 1 ? '修改' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('feiyongdingdan','修改') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
              ...
              <el-button v-if="isAuth('feiyongdingdan','修改') && contents.tableBtnIcon == 0" size="mini" type="primary"
                         @click="addOrUpdateHandler(scope.row.id)">{{ contents.tableBtnFont == 1 ? '修改' : '' }}
              </el-button>


              <el-button
                  v-if="isAuth('feiyongdingdan','删除') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                  icon="el-icon-delete" size="mini" type="danger" @click="deleteHandler(scope.row.id)">
                {{ contents.tableBtnFont == 1 ? '删除' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('feiyongdingdan','删除') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
              ...
              <el-button v-if="isAuth('feiyongdingdan','删除') && contents.tableBtnIcon == 0" size="mini" type="danger"

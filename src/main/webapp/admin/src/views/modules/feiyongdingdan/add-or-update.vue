<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="租赁编号" prop="zulinbianhao">
            <el-input v-model="ruleForm.zulinbianhao"
                      :readonly="ro.zulinbianhao" clearable placeholder="租赁编号"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="充电宝编号" prop="chongdianbaobianhao">
            <el-input v-model="ruleForm.chongdianbaobianhao"
                      :readonly="ro.chongdianbaobianhao" clearable placeholder="充电宝编号"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="select" label="区域" prop="quyu">
        ...
        <el-col :span="24">
          <el-form-item v-if="type!='info' && !ro.tupian" class="upload" label="图片" prop="tupian">
            <file-upload
          ...
          <div v-else>
            <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
              <img v-for="(item,index) in ruleForm.tupian.split(',')" v-bind:key="index" :src="item"
                   height="100" style="margin-right:20px;" width="100">
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="商户编号" prop="shanghubianhao">
            <el-input v-model="ruleForm.shanghubianhao"
                      :readonly="ro.shanghubianhao" clearable placeholder="商户编号"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="商户名称" prop="shanghumingcheng">
            <el-input v-model="ruleForm.shanghumingcheng"
                      :readonly="ro.shanghumingcheng" clearable placeholder="商户名称"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="开始时间" prop="kaishishijian">
            <el-input v-model="ruleForm.kaishishijian"
                      :readonly="ro.kaishishijian" clearable placeholder="开始时间"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="结束时间" prop="jieshushijian">
            <el-input v-model="ruleForm.jieshushijian"
                      :readonly="ro.jieshushijian" clearable placeholder="结束时间"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="每小时费用" prop="meixiaoshifeiyong">
            <el-input v-model="ruleForm.meixiaoshifeiyong"
                      :readonly="ro.meixiaoshifeiyong" clearable placeholder="每小时费用"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="租赁时长" prop="zulinshizhang">
            <el-input v-model="ruleForm.zulinshizhang"
                      :readonly="ro.zulinshizhang" clearable placeholder="租赁时长"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="押金" prop="yajin">
            <el-input v-model="ruleForm.yajin"
                      :readonly="ro.yajin" clearable placeholder="押金"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="租赁时长" prop="yajin">
              <el-input v-model="ruleForm.yajin"
                        placeholder="租赁时长" readonly></el-input>
            </el-form-item>
          </div>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="租赁费用" prop="zulinfeiyong">
            <el-input v-model="zulinfeiyong"
                      placeholder="租赁费用" readonly></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item v-if="ruleForm.zulinfeiyong" class="input" label="租赁费用" prop="zulinfeiyong">
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="用户账号" prop="yonghuzhanghao">
            <el-input v-model="ruleForm.yonghuzhanghao"
                      :readonly="ro.yonghuzhanghao" clearable placeholder="用户账号"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="用户姓名" prop="yonghuxingming">
            <el-input v-model="ruleForm.yonghuxingming"
                      :readonly="ro.yonghuxingming" clearable placeholder="用户姓名"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="用户手机" prop="yonghushouji">
            <el-input v-model="ruleForm.yonghushouji"
                      :readonly="ro.yonghushouji" clearable placeholder="用户手机"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="人员账号" prop="renyuanzhanghao">
            <el-input v-model="ruleForm.renyuanzhanghao"
                      :readonly="ro.renyuanzhanghao" clearable placeholder="人员账号"></el-input>
          </el-form-item>
          <div v-else>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="input" label="人员姓名" prop="renyuanxingming">
            <el-input v-model="ruleForm.renyuanxingming"
                      :readonly="ro.renyuanxingming" clearable placeholder="人员姓名"></el-input>
          </el-form-item>
          <div v-else>
  ...
  data() {
    ...
    return {
      addEditForm: {
        ...
        "btnSaveBgColor": "rgba(36, 194, 205, 1)",
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          ...
          if (!this.ruleForm.id) {
            this.$http({
              url: `guihaidingdan/deleteByZulinbianhao`,
              method: "post",
              data: {
                zulinbianhao: this.ruleForm.zulinbianhao
              }
            })
          }
          this.$http({

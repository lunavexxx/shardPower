<template>
  <div class="main-content">
        ...
        <el-row :gutter="20" class="slt"
          ...
          <el-form-item :label="contents.inputTitle == 1 ? '租赁编号' : ''">
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search"
                      v-model="searchForm.zulinbianhao" placeholder="租赁编号" clearable></el-input>
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search"
                      v-model="searchForm.zulinbianhao" placeholder="租赁编号" clearable></el-input>
            <el-input v-if="contents.inputIcon == 0" v-model="searchForm.zulinbianhao" placeholder="租赁编号"
                      clearable></el-input>
          </el-form-item>
          <el-form-item :label="contents.inputTitle == 1 ? '充电宝编号' : ''">
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search"
                      v-model="searchForm.chongdianbaobianhao" placeholder="充电宝编号" clearable></el-input>
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search"
                      v-model="searchForm.chongdianbaobianhao" placeholder="充电宝编号" clearable></el-input>
            <el-input v-if="contents.inputIcon == 0" v-model="searchForm.chongdianbaobianhao" placeholder="充电宝编号"
                      clearable></el-input>
          </el-form-item>
          <el-form-item :label="contents.inputTitle == 1 ? '商户名称' : ''">
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search"
                      v-model="searchForm.shanghumingcheng" placeholder="商户名称" clearable></el-input>
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search"
                      v-model="searchForm.shanghumingcheng" placeholder="商户名称" clearable></el-input>
            <el-input v-if="contents.inputIcon == 0" v-model="searchForm.shanghumingcheng" placeholder="商户名称"
                      clearable></el-input>
          </el-form-item>
          <el-form-item :label="contents.inputTitle == 1 ? '用户姓名' : ''">
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search"
                      v-model="searchForm.yonghuxingming" placeholder="用户姓名" clearable></el-input>
            <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search"
                      v-model="searchForm.yonghuxingming" placeholder="用户姓名" clearable></el-input>
      ...
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
          ...
          <el-table-column width="300" :align="contents.tableAlign"
            ...
            <template slot-scope="scope">
              <el-button
                  v-if="isAuth('guihaidingdan','查看') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                  type="success" icon="el-icon-tickets" size="mini" @click="addOrUpdateHandler(scope.row.id,'info')">
                {{ contents.tableBtnFont == 1 ? '详情' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('guihaidingdan','查看') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
              ...
              <el-button v-if="isAuth('guihaidingdan','查看') && contents.tableBtnIcon == 0" type="success" size="mini"
                         @click="addOrUpdateHandler(scope.row.id,'info')">{{ contents.tableBtnFont == 1 ? '详情' : '' }}
              </el-button>
              <div v-if="scope.row.sfsh == '是'">
                <el-button
                    v-if="isAuth('guihaidingdan','费用') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                    type="success" icon="el-icon-tickets" size="mini"
                    @click="feiyongdingdanCrossAddOrUpdateHandler(scope.row,'cross')">
                  {{ contents.tableBtnFont == 1 ? '费用' : '' }}
                </el-button>
                <el-button
                    v-if="isAuth('guihaidingdan','费用') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
                    type="success" size="mini" @click="feiyongdingdanCrossAddOrUpdateHandler(scope.row,'cross')">
                  {{ contents.tableBtnFont == 1 ? '费用' : '' }}<i class="el-icon-tickets el-icon--right"/></el-button>
                <el-button v-if="isAuth('guihaidingdan','费用') && contents.tableBtnIcon == 0" type="success" size="mini"
                           @click="feiyongdingdanCrossAddOrUpdateHandler(scope.row,'cross')">
                  {{ contents.tableBtnFont == 1 ? '费用' : '' }}
                </el-button>
              </div>
              <el-button
                  v-if="isAuth('guihaidingdan','修改') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                  type="primary" icon="el-icon-edit" size="mini" @click="addOrUpdateHandler(scope.row.id)">
                {{ contents.tableBtnFont == 1 ? '修改' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('guihaidingdan','修改') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
              ...
              <el-button v-if="isAuth('guihaidingdan','修改') && contents.tableBtnIcon == 0" type="primary" size="mini"
                         @click="addOrUpdateHandler(scope.row.id)">{{ contents.tableBtnFont == 1 ? '修改' : '' }}
              </el-button>


              <el-button
                  v-if="isAuth('guihaidingdan','删除') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1"
                  type="danger" icon="el-icon-delete" size="mini" @click="deleteHandler(scope.row.id)">
                {{ contents.tableBtnFont == 1 ? '删除' : '' }}
              </el-button>
              <el-button
                  v-if="isAuth('guihaidingdan','删除') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2"
              ...
              <el-button v-if="isAuth('guihaidingdan','删除') && contents.tableBtnIcon == 0" type="danger" size="mini"
    ...
    <feiyongdingdan-cross-add-or-update v-if="feiyongdingdanCrossAddOrUpdateFlag" :parent="this"
                                        ref="feiyongdingdanCrossaddOrUpdate"></feiyongdingdan-cross-add-or-update>

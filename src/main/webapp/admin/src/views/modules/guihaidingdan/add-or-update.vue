  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item v-if="type!='info'" class="date" label="结束时间" prop="jieshushijian">
            <el-date-picker
          ...
          <div v-else>
            <el-form-item v-if="ruleForm.jieshushijian" class="input" label="结束时间" prop="jieshushijian">
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          ...
          if (!this.ruleForm.id) {
            this.$http({
              url: `zulindingdan/deleteByZulinbianhao`,
              method: "post",
              data: {

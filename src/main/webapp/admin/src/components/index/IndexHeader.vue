<template>
  ...
  <div class="navbar"
    ...
    <div class="right-menu">
      ...
      <!--			<div class="logout" :style="{color:heads.,fontSize:heads.headLogoutFontSize}" @click="onIndexTap">退出到前台</div>-->
  ...
  data() {
    return {
      ...
      heads: {
        ...
        "headBoxShadow": "0px 0px 0px #32D088",
        "headTitleImgHeight": "44px",
        "headLogoutFontHoverBgColor": "rgba(36, 194, 205, 1)",

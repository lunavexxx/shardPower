  ...
  <el-aside class="index-aside" height="100vh" width="280px">
    <div class="index-aside-inner menulist" style="height:100%">
      <div v-for="item in menuList" v-if="role==item.roleName" :key="item.roleName" class="menulist-item"
           style="height:100%;broder:0;background-color:#24C2CD">
        ...
        <el-menu :unique-opened="true" active-text-color="#FFFFFF" background-color="#24C2CD" class="el-menu-demo"
                 default-active="0" mode="vertical" style="height:100%;" text-color="#FFFFFF">
          <el-menu-item :style="menulistBorderBottom" index="0" @click="menuHandler('')"><i v-if="false"
